;========================================================================================
;
; filetest.x version 1.01  by みゆ (miyu rose)
;
;========================================================================================
...
;-----------------------------------------------------------------------------------------
    ...
    pea.l   (filename)                          ;  ファイル名のポインタ を指定して
...
;-----------------------------------------------------------------------------------------
; 08: そのファイルを読み込み/書き込みモードで_OPEN → エラーにならない
;-----------------------------------------------------------------------------------------

    pea.l   (mes_08)                            ; チェック項目 を
    DOS     _PRINT                              ;  表示するよ
    addq.l  #4,sp                               ; SP を戻します
...
mes_08:
    .dc.b '08: そのファイルを読み込み/書き込みモードで_OPEN → エラーにならない',$00
mes_09:
